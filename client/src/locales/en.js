export default {
  ...
  restocking: {
    ...
    description: 'Purchase order recommendations based on stock levels, demand forecasts, and your budget',
    budgetCeiling: 'Budget Ceiling',
    budgetPlaceholder: 'Enter max budget...',
    apply: 'Apply',
    clearBudget: 'Clear',
    recommendations: 'Purchase Order Recommendations',
    noItems: 'All items are sufficiently stocked — no restocking needed.',
    stats: {
